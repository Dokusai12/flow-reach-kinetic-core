...
import { Menu, X, ArrowRight, Play, Pause, RotateCcw, Zap, Brain, Target, TrendingUp, Calendar, Sparkles, Activity, BarChart3, Users, Clock, DollarSign } from "lucide-react";
...
const MainSite = () => {
  ...
  const handleIndustrySelect = (industryId: string) => {
    ...
    // Animate through processes with staggered timing
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      {/* Mouse Follower */}
      <div 
        className="fixed w-4 h-4 bg-cyan-400/20 rounded-full pointer-events-none z-50 transition-all duration-300 ease-out"
        style={{
      ...
      >
        <div className="relative z-10 text-center max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <Badge className="bg-cyan-500/20 text-cyan-400 border-cyan-500/30 px-6 py-3 text-sm font-medium mb-8 animate-pulse">
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-20 max-w-7xl mx-auto">
          ...
          {selectedIndustry && (
            <div className="max-w-6xl mx-auto">
                ...
                {processes[selectedIndustry as keyof typeof processes].map((process, index) => (
                  <Card
                    ...
                    style={{ 
                      ...
                      transform: index <= currentProcess ? 'scale(1.02)' : 'scale(1)'
                    }}
                  >
              ...
              {currentProcess === processes[selectedIndustry as keyof typeof processes].length - 1 && (
                <Card className="mt-12 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-green-400/50 shadow-2xl shadow-green-500/25">
      ...
      <footer className="bg-gray-900 py-16">
        <div className="container mx-auto px-6 text-center">
          <img src={logo} alt="Flow Reach" className="h-16 mx-auto mb-8 hover:scale-110 transition-transform duration-300" />
